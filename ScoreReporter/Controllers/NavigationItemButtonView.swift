...
class NavigationItemButtonView: UIView {
    ...
    init?(viewController: UIViewController, backImageWidth: CGFloat) {
        ...
        let attributes = viewController.navigationItem.backBarButtonItem?.titleTextAttributesForState(.Normal) ?? viewController.navigationController?.navigationBar.titleTextAttributes
